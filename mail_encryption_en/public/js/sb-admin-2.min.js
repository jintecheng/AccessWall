...
! function(t) {
    "use strict";
    t("#sidebarToggle, #sidebarToggleTop").on("click", function(o) { t("#mbtn").css('font-size', 'medium'), t("#mbtn1").css('font-size', 'medium'), t("body").toggleClass("sidebar-toggled"), t(".sidebar").toggleClass("toggled"), t(".sidebar").hasClass("toggled") && (t(".sidebar .collapse").collapse("hide"), t("#mbtn").css('font-size', 'x-small'), t("#mbtn1").css('font-size', 'x-small')) }), t(window).resize(function() { t(window).width() < 768 && t(".sidebar .collapse").collapse("hide") }), t("body.fixed-nav .sidebar").on("mousewheel DOMMouseScroll wheel", function(o) {
