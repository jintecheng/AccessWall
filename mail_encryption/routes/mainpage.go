...
func index(w http.ResponseWriter, r *http.Request) {
	LoggedIn(w, r, "/login")
	t, err := template.ParseFiles("public/menu_index.html", "public/_head.html", "public/_menu.html", "public/_header.html", "public/_table.html")
	if err != nil {
		panic(err)
	}
	...
	if mailadd != "<nil>" && mailadd != "" && mailadd != "[]" {
		t.Execute(w, imapPage(mailadd, "1"))
	} else {
		t.Execute(w, nil)
	}
}

func imapPage(s string, num string) TodoPageData {
